...
var _user$project$Joke$update = F2(
	function (currentJoke, msg) {
		var _p0 = msg;
		if (_p0.ctor === 'FetchSuccess') {
			return _p0._0.value.joke;
		} else {
			var _p1 = _p0._0;
			if (_p1.ctor === 'UnexpectedPayload') {
				var _p2 = _p1._0;
				return A2(_elm_lang$core$Debug$log, _p2, _p2);
			} else {
				return 'Some other error occured';
			}
		}
	});
var _user$project$Joke$JokeResponse = function (a) {
	return {value: a};
};
var _user$project$Joke$JokeJson = function (a) {
	return {joke: a};
};
var _user$project$Joke$jokeDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$Joke$JokeJson,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'joke', _elm_lang$core$Json_Decode$string));
var _user$project$Joke$jokeResponseDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$Joke$JokeResponse,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'value', _user$project$Joke$jokeDecoder));
var _user$project$Joke$FetchFailure = function (a) {
	return {ctor: 'FetchFailure', _0: a};
};
var _user$project$Joke$FetchSuccess = function (a) {
	return {ctor: 'FetchSuccess', _0: a};
};
var _user$project$Joke$fetchRandomJoke = function () {
	var task = A2(_evancz$elm_http$Http$get, _user$project$Joke$jokeResponseDecoder, 'http://api.icndb.com/jokes/random');
	return A3(_elm_lang$core$Task$perform, _user$project$Joke$FetchFailure, _user$project$Joke$FetchSuccess, task);
}();

var _user$project$App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var newJoke = A2(_user$project$Joke$update, model.joke, _p0._0);
		return {
			ctor: '_Tuple2',
...
var _user$project$App$innerHtml = function (_p1) {
	return A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$App$innerHtml(model.joke)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
};
var _user$project$App$initialModel = {joke: 'Nope'};
var _user$project$App$Model = function (a) {
	return {joke: a};
};
var _user$project$App$JokeMsg = function (a) {
	return {ctor: 'JokeMsg', _0: a};
};
var _user$project$App$init = {
	ctor: '_Tuple2',
	_0: _user$project$App$initialModel,
	_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$JokeMsg, _user$project$Joke$fetchRandomJoke)
};
